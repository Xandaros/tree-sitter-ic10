...
static bool ts_lex_keywords(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 2197:
      ...
      if (lookahead == 'D') ADVANCE(2444);
      if (lookahead == 'E') ADVANCE(2445);
      if (lookahead == 'F') ADVANCE(2446);
      if (lookahead == 'G') ADVANCE(2447);
      if (lookahead == 'H') ADVANCE(2448);
      if (lookahead == 'L') ADVANCE(2449);
      if (lookahead == 'M') ADVANCE(2450);
      if (lookahead == 'N') ADVANCE(2451);
      if (lookahead == 'O') ADVANCE(2452);
      if (lookahead == 'P') ADVANCE(2453);
      if (lookahead == 'Q') ADVANCE(2454);
      if (lookahead == 'R') ADVANCE(2455);
      if (lookahead == 'S') ADVANCE(2456);
      if (lookahead == 'T') ADVANCE(2457);
      if (lookahead == 'V') ADVANCE(2458);
      END_STATE();
    case 2198:
    ...
    case 2517:
      ...
      if (lookahead == 'L') ADVANCE(2771);
      if (lookahead == 'N') ADVANCE(2772);
      if (lookahead == 'O') ADVANCE(2773);
      if (lookahead == 'P') ADVANCE(2774);
      if (lookahead == 'S') ADVANCE(2775);
      if (lookahead == 'V') ADVANCE(2776);
      if (lookahead == 'W') ADVANCE(2777);
      END_STATE();
    case 2518:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    ...
    [sym_logictype] = STATE(14),
    [sym_logicslottype] = STATE(14),
    [sym_batchmode] = STATE(14),
    [sym_reagentmode] = STATE(14),
  ...
  [3] = {
    ...
    [sym_register] = ACTIONS(56),
    [sym_device] = ACTIONS(59),
    [anon_sym_nan] = ACTIONS(62),
    [anon_sym_pinf] = ACTIONS(62),
    [anon_sym_ninf] = ACTIONS(62),
    [anon_sym_pi] = ACTIONS(62),
    [anon_sym_deg2rad] = ACTIONS(62),
    [anon_sym_rad2deg] = ACTIONS(62),
    [anon_sym_epsilon] = ACTIONS(62),
    [anon_sym_HASH_LPAREN_DQUOTE] = ACTIONS(65),
    [aux_sym_number_token1] = ACTIONS(68),
    [anon_sym_Acceleration] = ACTIONS(71),
    [anon_sym_Activate] = ACTIONS(71),
    [anon_sym_AirRelease] = ACTIONS(71),
    [anon_sym_AlignmentError] = ACTIONS(71),
    [anon_sym_Apex] = ACTIONS(71),
    [anon_sym_AutoLand] = ACTIONS(71),
    [anon_sym_AutoShutOff] = ACTIONS(71),
    [anon_sym_Bpm] = ACTIONS(71),
    [anon_sym_BurnTimeRemaining] = ACTIONS(71),
    [anon_sym_CelestialHash] = ACTIONS(71),
    [anon_sym_CelestialParentHash] = ACTIONS(71),
    [anon_sym_Channel0] = ACTIONS(71),
    [anon_sym_Channel1] = ACTIONS(71),
    [anon_sym_Channel2] = ACTIONS(71),
    [anon_sym_Channel3] = ACTIONS(71),
    [anon_sym_Channel4] = ACTIONS(71),
    [anon_sym_Channel5] = ACTIONS(71),
    [anon_sym_Channel6] = ACTIONS(71),
    [anon_sym_Channel7] = ACTIONS(71),
    [anon_sym_Charge] = ACTIONS(74),
    [anon_sym_Chart] = ACTIONS(71),
    [anon_sym_ChartedNavPoints] = ACTIONS(71),
    [anon_sym_ClearMemory] = ACTIONS(71),
    [anon_sym_CollectableGoods] = ACTIONS(71),
    [anon_sym_Color] = ACTIONS(71),
    [anon_sym_Combustion] = ACTIONS(71),
    [anon_sym_CombustionInput] = ACTIONS(71),
    [anon_sym_CombustionInput2] = ACTIONS(71),
    [anon_sym_CombustionLimiter] = ACTIONS(71),
    [anon_sym_CombustionOutput] = ACTIONS(71),
    [anon_sym_CombustionOutput2] = ACTIONS(71),
    [anon_sym_CompletionRatio] = ACTIONS(71),
    [anon_sym_ContactTypeId] = ACTIONS(71),
    [anon_sym_CurrentCode] = ACTIONS(71),
    [anon_sym_CurrentResearchPodType] = ACTIONS(71),
    [anon_sym_Density] = ACTIONS(71),
    [anon_sym_DestinationCode] = ACTIONS(71),
    [anon_sym_Discover] = ACTIONS(71),
    [anon_sym_DistanceAu] = ACTIONS(71),
    [anon_sym_DistanceKm] = ACTIONS(71),
    [anon_sym_DrillCondition] = ACTIONS(71),
    [anon_sym_DryMass] = ACTIONS(71),
    [anon_sym_Eccentricity] = ACTIONS(71),
    [anon_sym_ElevatorLevel] = ACTIONS(71),
    [anon_sym_ElevatorSpeed] = ACTIONS(71),
    [anon_sym_EntityState] = ACTIONS(71),
    [anon_sym_EnvironmentEfficiency] = ACTIONS(71),
    [anon_sym_Error] = ACTIONS(71),
    [anon_sym_ExhaustVelocity] = ACTIONS(71),
    [anon_sym_ExportCount] = ACTIONS(71),
    [anon_sym_ExportQuantity] = ACTIONS(71),
    [anon_sym_ExportSlotHash] = ACTIONS(71),
    [anon_sym_ExportSlotOccupant] = ACTIONS(71),
    [anon_sym_Filtration] = ACTIONS(71),
    [anon_sym_FlightControlRule] = ACTIONS(71),
    [anon_sym_Flush] = ACTIONS(71),
    [anon_sym_ForceWrite] = ACTIONS(71),
    [anon_sym_ForwardX] = ACTIONS(71),
    [anon_sym_ForwardY] = ACTIONS(71),
    [anon_sym_ForwardZ] = ACTIONS(71),
    [anon_sym_Fuel] = ACTIONS(71),
    [anon_sym_Harvest] = ACTIONS(71),
    [anon_sym_Horizontal] = ACTIONS(71),
    [anon_sym_HorizontalRatio] = ACTIONS(71),
    [anon_sym_Idle] = ACTIONS(71),
    [anon_sym_ImportCount] = ACTIONS(71),
    [anon_sym_ImportQuantity] = ACTIONS(71),
    [anon_sym_ImportSlotHash] = ACTIONS(71),
    [anon_sym_ImportSlotOccupant] = ACTIONS(71),
    [anon_sym_Inclination] = ACTIONS(71),
    [anon_sym_Index] = ACTIONS(71),
    [anon_sym_InterrogationProgress] = ACTIONS(71),
    [anon_sym_LineNumber] = ACTIONS(74),
    [anon_sym_Lock] = ACTIONS(74),
    [anon_sym_ManualResearchRequiredPod] = ACTIONS(71),
    [anon_sym_Mass] = ACTIONS(71),
    [anon_sym_Maximum] = ACTIONS(77),
    [anon_sym_MineablesInQueue] = ACTIONS(71),
    [anon_sym_MineablesInVicinity] = ACTIONS(71),
    [anon_sym_MinedQuantity] = ACTIONS(71),
    [anon_sym_MinimumWattsToContact] = ACTIONS(71),
    [anon_sym_Mode] = ACTIONS(71),
    [anon_sym_NavPoints] = ACTIONS(71),
    [anon_sym_NextWeatherEventTime] = ACTIONS(71),
    [anon_sym_None] = ACTIONS(74),
    [anon_sym_On] = ACTIONS(74),
    [anon_sym_Open] = ACTIONS(74),
    [anon_sym_OperationalTemperatureEfficiency] = ACTIONS(71),
    [anon_sym_OrbitPeriod] = ACTIONS(71),
    [anon_sym_Orientation] = ACTIONS(71),
    [anon_sym_Output] = ACTIONS(71),
    [anon_sym_PassedMoles] = ACTIONS(71),
    [anon_sym_Plant] = ACTIONS(71),
    [anon_sym_PlantEfficiency1] = ACTIONS(71),
    [anon_sym_PlantEfficiency2] = ACTIONS(71),
    [anon_sym_PlantEfficiency3] = ACTIONS(71),
    [anon_sym_PlantEfficiency4] = ACTIONS(71),
    [anon_sym_PlantGrowth1] = ACTIONS(71),
    [anon_sym_PlantGrowth2] = ACTIONS(71),
    [anon_sym_PlantGrowth3] = ACTIONS(71),
    [anon_sym_PlantGrowth4] = ACTIONS(71),
    [anon_sym_PlantHash1] = ACTIONS(71),
    [anon_sym_PlantHash2] = ACTIONS(71),
    [anon_sym_PlantHash3] = ACTIONS(71),
    [anon_sym_PlantHash4] = ACTIONS(71),
    [anon_sym_PlantHealth1] = ACTIONS(71),
    [anon_sym_PlantHealth2] = ACTIONS(71),
    [anon_sym_PlantHealth3] = ACTIONS(71),
    [anon_sym_PlantHealth4] = ACTIONS(71),
    [anon_sym_PositionX] = ACTIONS(71),
    [anon_sym_PositionY] = ACTIONS(71),
    [anon_sym_PositionZ] = ACTIONS(71),
    [anon_sym_Power] = ACTIONS(71),
    [anon_sym_PowerActual] = ACTIONS(71),
    [anon_sym_PowerGeneration] = ACTIONS(71),
    [anon_sym_PowerPotential] = ACTIONS(71),
    [anon_sym_PowerRequired] = ACTIONS(71),
    [anon_sym_PrefabHash] = ACTIONS(74),
    [anon_sym_Pressure] = ACTIONS(74),
    [anon_sym_PressureEfficiency] = ACTIONS(71),
    [anon_sym_PressureExternal] = ACTIONS(71),
    [anon_sym_PressureInput] = ACTIONS(71),
    [anon_sym_PressureInput2] = ACTIONS(71),
    [anon_sym_PressureInternal] = ACTIONS(71),
    [anon_sym_PressureOutput] = ACTIONS(71),
    [anon_sym_PressureOutput2] = ACTIONS(71),
    [anon_sym_PressureSetting] = ACTIONS(71),
    [anon_sym_Progress] = ACTIONS(71),
    [anon_sym_Quantity] = ACTIONS(74),
    [anon_sym_Ratio] = ACTIONS(71),
    [anon_sym_RatioCarbonDioxide] = ACTIONS(71),
    [anon_sym_RatioCarbonDioxideInput] = ACTIONS(71),
    [anon_sym_RatioCarbonDioxideInput2] = ACTIONS(71),
    [anon_sym_RatioCarbonDioxideOutput] = ACTIONS(71),
    [anon_sym_RatioCarbonDioxideOutput2] = ACTIONS(71),
    [anon_sym_RatioHydrogen] = ACTIONS(71),
    [anon_sym_RatioLiquidCarbonDioxide] = ACTIONS(71),
    [anon_sym_RatioLiquidCarbonDioxideInput] = ACTIONS(71),
    [anon_sym_RatioLiquidCarbonDioxideInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidCarbonDioxideOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidCarbonDioxideOutput2] = ACTIONS(71),
    [anon_sym_RatioLiquidHydrogen] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrogen] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrogenInput] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrogenInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrogenOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrogenOutput2] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrousOxide] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrousOxideInput] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrousOxideInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrousOxideOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidNitrousOxideOutput2] = ACTIONS(71),
    [anon_sym_RatioLiquidOxygen] = ACTIONS(71),
    [anon_sym_RatioLiquidOxygenInput] = ACTIONS(71),
    [anon_sym_RatioLiquidOxygenInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidOxygenOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidOxygenOutput2] = ACTIONS(71),
    [anon_sym_RatioLiquidPollutant] = ACTIONS(71),
    [anon_sym_RatioLiquidPollutantInput] = ACTIONS(71),
    [anon_sym_RatioLiquidPollutantInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidPollutantOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidPollutantOutput2] = ACTIONS(71),
    [anon_sym_RatioLiquidVolatiles] = ACTIONS(71),
    [anon_sym_RatioLiquidVolatilesInput] = ACTIONS(71),
    [anon_sym_RatioLiquidVolatilesInput2] = ACTIONS(71),
    [anon_sym_RatioLiquidVolatilesOutput] = ACTIONS(71),
    [anon_sym_RatioLiquidVolatilesOutput2] = ACTIONS(71),
    [anon_sym_RatioNitrogen] = ACTIONS(71),
    [anon_sym_RatioNitrogenInput] = ACTIONS(71),
    [anon_sym_RatioNitrogenInput2] = ACTIONS(71),
    [anon_sym_RatioNitrogenOutput] = ACTIONS(71),
    [anon_sym_RatioNitrogenOutput2] = ACTIONS(71),
    [anon_sym_RatioNitrousOxide] = ACTIONS(71),
    [anon_sym_RatioNitrousOxideInput] = ACTIONS(71),
    [anon_sym_RatioNitrousOxideInput2] = ACTIONS(71),
    [anon_sym_RatioNitrousOxideOutput] = ACTIONS(71),
    [anon_sym_RatioNitrousOxideOutput2] = ACTIONS(71),
    [anon_sym_RatioOxygen] = ACTIONS(71),
    [anon_sym_RatioOxygenInput] = ACTIONS(71),
    [anon_sym_RatioOxygenInput2] = ACTIONS(71),
    [anon_sym_RatioOxygenOutput] = ACTIONS(71),
    [anon_sym_RatioOxygenOutput2] = ACTIONS(71),
    [anon_sym_RatioPollutant] = ACTIONS(71),
    [anon_sym_RatioPollutantInput] = ACTIONS(71),
    [anon_sym_RatioPollutantInput2] = ACTIONS(71),
    [anon_sym_RatioPollutantOutput] = ACTIONS(71),
    [anon_sym_RatioPollutantOutput2] = ACTIONS(71),
    [anon_sym_RatioPollutedWater] = ACTIONS(71),
    [anon_sym_RatioSteam] = ACTIONS(71),
    [anon_sym_RatioSteamInput] = ACTIONS(71),
    [anon_sym_RatioSteamInput2] = ACTIONS(71),
    [anon_sym_RatioSteamOutput] = ACTIONS(71),
    [anon_sym_RatioSteamOutput2] = ACTIONS(71),
    [anon_sym_RatioVolatiles] = ACTIONS(71),
    [anon_sym_RatioVolatilesInput] = ACTIONS(71),
    [anon_sym_RatioVolatilesInput2] = ACTIONS(71),
    [anon_sym_RatioVolatilesOutput] = ACTIONS(71),
    [anon_sym_RatioVolatilesOutput2] = ACTIONS(71),
    [anon_sym_RatioWater] = ACTIONS(71),
    [anon_sym_RatioWaterInput] = ACTIONS(71),
    [anon_sym_RatioWaterInput2] = ACTIONS(71),
    [anon_sym_RatioWaterOutput] = ACTIONS(71),
    [anon_sym_RatioWaterOutput2] = ACTIONS(71),
    [anon_sym_ReEntryAltitude] = ACTIONS(71),
    [anon_sym_Reagents] = ACTIONS(71),
    [anon_sym_RecipeHash] = ACTIONS(71),
    [anon_sym_ReferenceId] = ACTIONS(74),
    [anon_sym_RequestHash] = ACTIONS(71),
    [anon_sym_RequiredPower] = ACTIONS(71),
    [anon_sym_ReturnFuelCost] = ACTIONS(71),
    [anon_sym_Richness] = ACTIONS(71),
    [anon_sym_Rpm] = ACTIONS(71),
    [anon_sym_SemiMajorAxis] = ACTIONS(71),
    [anon_sym_Setting] = ACTIONS(71),
    [anon_sym_SettingInput] = ACTIONS(71),
    [anon_sym_SettingOutput] = ACTIONS(71),
    [anon_sym_SignalID] = ACTIONS(71),
    [anon_sym_SignalStrength] = ACTIONS(71),
    [anon_sym_Sites] = ACTIONS(71),
    [anon_sym_Size] = ACTIONS(71),
    [anon_sym_SizeX] = ACTIONS(71),
    [anon_sym_SizeY] = ACTIONS(71),
    [anon_sym_SizeZ] = ACTIONS(71),
    [anon_sym_SolarAngle] = ACTIONS(71),
    [anon_sym_SolarIrradiance] = ACTIONS(71),
    [anon_sym_SoundAlert] = ACTIONS(71),
    [anon_sym_Stress] = ACTIONS(71),
    [anon_sym_Survey] = ACTIONS(71),
    [anon_sym_TargetPadIndex] = ACTIONS(71),
    [anon_sym_TargetX] = ACTIONS(71),
    [anon_sym_TargetY] = ACTIONS(71),
    [anon_sym_TargetZ] = ACTIONS(71),
    [anon_sym_Temperature] = ACTIONS(74),
    [anon_sym_TemperatureDifferentialEfficiency] = ACTIONS(71),
    [anon_sym_TemperatureExternal] = ACTIONS(71),
    [anon_sym_TemperatureInput] = ACTIONS(71),
    [anon_sym_TemperatureInput2] = ACTIONS(71),
    [anon_sym_TemperatureOutput] = ACTIONS(71),
    [anon_sym_TemperatureOutput2] = ACTIONS(71),
    [anon_sym_TemperatureSetting] = ACTIONS(71),
    [anon_sym_Throttle] = ACTIONS(71),
    [anon_sym_Thrust] = ACTIONS(71),
    [anon_sym_ThrustToWeight] = ACTIONS(71),
    [anon_sym_Time] = ACTIONS(71),
    [anon_sym_TimeToDestination] = ACTIONS(71),
    [anon_sym_TotalMoles] = ACTIONS(71),
    [anon_sym_TotalMolesInput] = ACTIONS(71),
    [anon_sym_TotalMolesInput2] = ACTIONS(71),
    [anon_sym_TotalMolesOutput] = ACTIONS(71),
    [anon_sym_TotalMolesOutput2] = ACTIONS(71),
    [anon_sym_TotalQuantity] = ACTIONS(71),
    [anon_sym_TrueAnomaly] = ACTIONS(71),
    [anon_sym_VelocityMagnitude] = ACTIONS(71),
    [anon_sym_VelocityRelativeX] = ACTIONS(71),
    [anon_sym_VelocityRelativeY] = ACTIONS(71),
    [anon_sym_VelocityRelativeZ] = ACTIONS(71),
    [anon_sym_VelocityX] = ACTIONS(71),
    [anon_sym_VelocityY] = ACTIONS(71),
    [anon_sym_VelocityZ] = ACTIONS(71),
    [anon_sym_Vertical] = ACTIONS(71),
    [anon_sym_VerticalRatio] = ACTIONS(71),
    [anon_sym_Volume] = ACTIONS(74),
    [anon_sym_VolumeOfLiquid] = ACTIONS(71),
    [anon_sym_WattsReachingContact] = ACTIONS(71),
    [anon_sym_Weight] = ACTIONS(71),
    [anon_sym_WorkingGasEfficiency] = ACTIONS(71),
    [anon_sym_ChargeRatio] = ACTIONS(80),
    [anon_sym_Class] = ACTIONS(80),
    [anon_sym_Damage] = ACTIONS(80),
    [anon_sym_Efficiency] = ACTIONS(80),
    [anon_sym_FilterType] = ACTIONS(80),
    [anon_sym_Growth] = ACTIONS(80),
    [anon_sym_Health] = ACTIONS(80),
    [anon_sym_Mature] = ACTIONS(80),
    [anon_sym_MaxQuantity] = ACTIONS(80),
    [anon_sym_OccupantHash] = ACTIONS(80),
    [anon_sym_Occupied] = ACTIONS(80),
    [anon_sym_PressureAir] = ACTIONS(80),
    [anon_sym_PressureWaste] = ACTIONS(80),
    [anon_sym_Seeding] = ACTIONS(80),
    [anon_sym_SortingClass] = ACTIONS(80),
    [anon_sym_Average] = ACTIONS(83),
    [anon_sym_Minimum] = ACTIONS(83),
    [anon_sym_Sum] = ACTIONS(83),
    [anon_sym_Contents] = ACTIONS(86),
    [anon_sym_Recipe] = ACTIONS(86),
    [anon_sym_Required] = ACTIONS(86),
    [anon_sym_TotalContents] = ACTIONS(86),
    [sym_enum] = ACTIONS(68),
    [sym_deprecated] = ACTIONS(89),
  },
  [4] = {
    [sym_operand] = STATE(13),
    [sym_device_spec] = STATE(15),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(15),
  [52] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7),
  [56] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(15),
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(7),
  [62] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(16),
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(34),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(8),
  [71] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(19),
  [74] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(20),
  [77] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(21),
  [80] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(18),
  [83] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(9),
  [86] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(17),
  [89] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 2, .production_id = 7), SHIFT_REPEAT(14),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, .production_id = 6),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_instruction, 2, .production_id = 6),
  [96] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, .production_id = 5),
  [98] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_instruction, 2, .production_id = 5),
  ...
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_device_spec, 1),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_device_spec, 1),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_number, 1),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_batchmode, 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_batchmode, 1),
  ...
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_instruction_repeat1, 1, .production_id = 4),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 1, .production_id = 4),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_logicable, 1),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logicable, 1),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_operand, 1),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operand, 1),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_constant, 1),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 1),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reagentmode, 1),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reagentmode, 1),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_logicslottype, 1),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logicslottype, 1),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_logictype, 1),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_logictype, 1),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, .production_id = 3),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [162] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(2),
  [165] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [168] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(24),
  [171] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(33),
  [174] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(12),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_newline, 1),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_newline, 1),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 1),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 1),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 2),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 2),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 3),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 3),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 1),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 1),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_label, 2),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_comment, 1),
  [203] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_comment, 1),
